...
class CreateCourseExerciseFormComponent(BaseComponent):
    def __init__(self, page: Page, index: int):
        ...
        self.delete_exercise_button = Button(
            page,f"create-course-exercise-{index}-box-toolbar-delete-exercise-button", 'Delete exercise'
        )
        self.subtitle = Text(
            page,f"create-course-exercise-{index}-box-toolbar-subtitle-text", 'Exercise subtitle'
        )
        self.title_input = Input(page, f"create-course-exercise-form-title-{index}-input", 'Title')
